...
const ProductDetails = ({ item }: ProductDetailsProps) => {
  ...
  // Deshabilitar el botón de disminuir la cantidad si la cantidad es 1, useMemo memoriza la función
  const disableDecreaseButton = useMemo(() => item.quantity === 1, [item]);
  // Deshabilitar el botón de aumentar la cantidad si la cantidad es 5, useMemo memoriza la función
